...
深さ優先探索
109~109.関数を定義
111~113.visited[]を初期化する
115.スタックを初期化する
116.スタックに出発点を入れる
118.スタックが空になるまで繰り返す
120.スタックから取り出す
121~126.もし行ったことがないなら行ったことにしその場所から行ける場所をスタックに入れる
131~134.場所訪れたことがあるかを表示する
幅優先探索
202~203.関数を定義
205~207.visited[]を初期化する
209.キューを初期化する
210.キューに出発点を入れる
212.キューが空になるまで繰り返す
214.キューから取り出す
215~220.もし行ったことがないなら行ったことにしその場所から行ける場所をキューに入れる
225~228.場所訪れたことがあるかを表示する
