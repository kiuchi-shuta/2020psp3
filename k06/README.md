...
75.関数の宣言
76~82.表の初期化
83~91.商品の数分繰り返し、商品の重さを１ずつ大きくしながら商品が入らない場合は上の状態を引き継ぐ。そうでない場合繰り返しから抜ける
83~99.商品の数分繰り返し、入れ替えた場合とそのままの場合のカロリーを比較し大きいほうの値になるようにする。
101.最大カロリーを表示する

## 出力結果

```
PS C:\Users\bb35319018\新しいフォルダー (7)\2020psp3\k06> gcc -o k06 k06.c
PS C:\Users\bb35319018\新しいフォルダー (7)\2020psp3\k06> ./k06
最大カロリー=1796
```
